...
- **ソースコード（Go ファイル）・コミットメッセージ・PR 説明・コメントはすべて英語で書く**
- 日本語を使用してよいファイルは `README.ja.md` と `CLAUDE.md`（このファイル自体）のみ
- エラーメッセージ・CLI 出力・cobra の Short/Long/Example フィールドもすべて英語
