...
a [newsyslog(8)](x-man-page://newsyslog) configuration that automatically
rotates all ldcron log files.
...
newsyslog runs automatically every hour via a system launchd job, so no
